...
const { createAppointment, getAppointments, getAppointmentById, updateAppointmentStatus, addNotes, getDoctorAnalytics, getSlots } = require('../controllers/appointment');
...
router.get('/slots', checkAuth, restrictTo(['patient']), getSlots);
